...
<tr class="tip">
	<td>姓名</td>
	<td width="80%" align="left"><input type=text name="name" id="nnnn" class="name" value="${a[5] }" Readonly></td> 
</tr>
<tr class="tip">
	<td width="20%">电话</td> 
...
<tr class="tip">
	<td width="20%">旧密码</td> 
	<td width="80%" align="left"><input type=text name="pwd" id="pwd" value="${a[6] }" Readonly></td> 
</tr>
<tr class="tip">
	<td width="20%">新密码</td> 
...
$("#form1").submit(function(){
	...
	if(src==''){
		...
		url+=arrUrl[arrUrl.length-1]; 
		  ...
		  var action="newxcphoto?way=2&name="+name+"";          
...
$("#form2").validate({
	...
	submitHandler:function(form){
		$(form).ajaxSubmit({
			type: 'POST',
			url: "updateUser.do?name="+$("#nnnn").val()+"",
			dataType: 'text',
...
$("#form3").validate({
	...
	submitHandler:function(form){
		$(form).ajaxSubmit({
			type: 'POST',
			url: "updatePwd.do?name="+$("#nnnn").val()+"",
			dataType: 'text',
			success: function(data){
				if(data==1){
					$("#pwd").val($("#newpwd").val());
