...
<%
  ...
  List<shareBean> sharee=ConnecttionPoolTest.showshare("1","2");
...
<div class="page-container">
	...
	<a class="btn btn-primary radius" href="admin/share-alllist.jsp"><i class="Hui-iconfont">&#xe634;</i>动态列表</a></span> <span class="r">共有数据：<strong class="count"><%=si %></strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${shares }" var="a">
				<tr class="text-c">
					...
					<td>${a.title }</td>
					<td>
					<img src="${a.url }" style="width:100px; height:100px; cursor:pointer;" onClick="article_show('查看','admin/sharemore.jsp?id=${a.id }')"/>
					</td>
					<td>${a.data }</td>
