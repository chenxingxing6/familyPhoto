  ...
  <div class="am-tabs-bd">
    ...
    <ul class="am-list">
      ...
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am_list_li">
        <div class="am-u-sm-3 am-list-thumb am_list_thumb" onClick="share_show('查看','user/phone/moreshare.jsp?id=${b.id }')">
          <a href="javascript:;">
        ...
        <div class=" am-u-sm-9 am-list-main am_list_main">
          <h3 class="am-list-item-hd am_list_title">
            <a href="javascript:;" onClick="share_show('查看','user/phone/moreshare.jsp?id=${b.id }')">${b.title}</a>
          </h3>
