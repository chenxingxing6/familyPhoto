...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel(this)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="user/phone/share.jsp"><i class="Hui-iconfont">&#xe634;</i> 分享图片</a></span> <span class="r">共有:<strong class="count"><%=si %></strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${shares }" var="a">
				<tr class="text-c">
					...
					<td>${a.title }</td>
					<td>
					<img src="${a.url }" style="width:100px; height:100px; cursor:pointer;" onClick="article_show('查看','user/phone/moreshare.jsp?id=${a.id }')"/>
					</td>
					<td>${a.data }</td>
